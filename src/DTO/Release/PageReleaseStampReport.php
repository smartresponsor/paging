 ...
 */
final readonly class PageReleaseStampReport
{
    /** @param list<PageReleaseStampItem> $items */
    ...
    {
        return count(array_filter($this->items, static fn (PageReleaseStampItem $item): bool => $item->passed));
    }
    ...
    public function toArray(): array
    {
        return [
            ...
            'items' => array_map(static fn (PageReleaseStampItem $item): array => $item->toArray(), $this->items),
        ];
    }
}
