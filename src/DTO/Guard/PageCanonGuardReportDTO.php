 ...
 */
final readonly class PageCanonGuardReportDTO
{
    /** @param list<PageCanonGuardItemDTO> $items */
    ...
    {
        return count(array_filter($this->items, static fn (PageCanonGuardItemDTO $item): bool => $item->passed));
    }
    ...
    public function toArray(): array
    {
        return [
            ...
            'items' => array_map(static fn (PageCanonGuardItemDTO $item): array => $item->toArray(), $this->items),
        ];
    }
}
