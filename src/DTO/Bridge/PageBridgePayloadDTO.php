...
final readonly class PageBridgePayloadDTO
{
    /**
     * @param array<string, mixed>|null     $bodyJson
     * @param list<PageBridgeAttachmentDTO> $attachments
     */
    public function __construct(
        ...
        public PageBridgeRenderHintsDTO $renderHints,
        public ?PageBridgeLegalNoticeDTO $legalNotice = null,
    ...
    public function toArray(): array
    {
        return [
            ...
            'attachments' => array_map(static fn (PageBridgeAttachmentDTO $attachment): array => $attachment->toArray(), $this->attachments),
