 ...
 */
final readonly class PageUserUsabilityReport
{
    /** @param list<PageUserUsabilityItem> $items */
    ...
    {
        return count(array_filter($this->items, static fn (PageUserUsabilityItem $item): bool => $item->componentReady));
    }
    ...
    public function ownerLayers(): array
    {
        return array_values(array_unique(array_map(
            static fn (PageUserUsabilityItem $item): string => $item->ownerLayer,
            $this->items,
        )));
    }
    ...
    public function toArray(): array
    {
        return [
            ...
            'items' => array_map(static fn (PageUserUsabilityItem $item): array => [
                'code' => $item->code,
