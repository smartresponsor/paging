 ...
 */
final readonly class PageCompletionReport
{
    /** @param list<PageCompletionItem> $items */
    ...
    {
        return count(array_filter($this->items, static fn (PageCompletionItem $item): bool => $item->passed));
    }
    ...
    public function toArray(): array
    {
        return [
            ...
            'items' => array_map(static fn (PageCompletionItem $item): array => $item->toArray(), $this->items),
        ];
    }
}
