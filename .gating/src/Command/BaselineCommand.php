...
/**
 * Provides the baseline command implementation used by the Gating runtime and rule execution flow.
 */
final class BaselineCommand extends AbstractGatingCommand
{
    /**
    ...
    {
        $this->setDescription('Discover targets and produce a non-destructive baseline report.');
        $this->addBaselineOptions();
    }
    ...
    {
        return $this->runner->runBaseline($input, $output);
    }
}
